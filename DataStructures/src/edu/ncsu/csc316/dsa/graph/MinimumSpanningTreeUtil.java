...
public class MinimumSpanningTreeUtil {
	...
	public static <V, E extends Weighted> PositionalList<Edge<E>> kruskal(Graph<V, E> g) {
		...
		PriorityQueue<Integer, Edge<E>> q = new HeapPriorityQueue<Integer, Graph.Edge<E>>();
		DisjointSetForest<Vertex<V>> d = new UpTreeDisjointSetForest<Graph.Vertex<V>>();
